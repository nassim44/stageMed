 ...
 */
final class Version20240813211859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inventory_product (inventory_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_924EA2519EEA759 (inventory_id), INDEX IDX_924EA2514584665A (product_id), PRIMARY KEY(inventory_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
