 ...
 */
final class Version20240805124151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rate ADD product_id INT DEFAULT NULL, ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DFEC3F394584665A ON rate');
        $this->addSql('DROP INDEX IDX_DFEC3F39A76ED395 ON rate');
        $this->addSql('ALTER TABLE rate DROP product_id, DROP user_id');
    }
}
