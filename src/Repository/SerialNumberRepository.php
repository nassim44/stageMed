...
/**
 * @extends ServiceEntityRepository<SerialNumber>
 *
...
class SerialNumberRepository extends ServiceEntityRepository
{
    ...
    public function save(SerialNumber $entity, bool $flush = true): void
    {
    ...
    public function remove(SerialNumber $entity, bool $flush = true): void
    {
